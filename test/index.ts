...
const main = () => {
  ...
  TestValidator.equals("check-exist-header")(
    swagger.paths["/connector/google-calendar/{calendarId}/get-events"].get.parameters[1].schema.$ref)("#/components/schemas/IAuthHeaders")
  TestValidator.equals("check-header-type")(
    swagger.components.schemas.IAuthHeaders.properties.secretKey["x-secret-key"]
  )("Google");
};
main();
